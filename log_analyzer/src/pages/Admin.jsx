  ...
  return (
    ...
    <div className="bg-linear-to-br  from-gray-950 to-sky-600 h-screen">
      ...
      <div className="p-10 flex justify-between">
        <div className="bg-black/60 backdrop-blur-sm rounded-2xl mt-10 w-110 h-120 justify-items-center">
        </div>
        <div className="bg-black/60 backdrop-blur-sm rounded-2xl mt-10 w-250 h-120 justify-items-center">
        </div>
