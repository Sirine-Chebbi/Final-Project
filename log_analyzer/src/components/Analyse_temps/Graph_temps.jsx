...
const Graph_temps = ({ tempsResults }) => {
  ...
  return (
    <>
      ...
      <div className="mb-10 flex-auto overflow-x-auto rounded-xl h-110 border-2 border-cyan-400 p-6 hover:shadow-2xl hover:shadow-cyan-400 mt-10 bg-gray-900 hover:scale-102 duration-200">
        ...
        {isLoading ? (
          ...
          <div className="relative h-80 w-full" ref={chartContainerRef}></div>
        )}
      </div>
    </>
  );
