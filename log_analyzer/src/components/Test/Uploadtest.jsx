...
const Uploadtest = ({ onUploadSuccess }) => {
  ...
  return (
    <div className="flex-none justify-between bg-gray-950 w-fit hover:scale-105 duration-200 mt-15">
      <div className="py-6">
          ...
          <div className="grid gap-5 mt-2">
            ...
            <div className="flex items-center justify-center gap-4">
              <label>
                ...
                />
                <div className={`
                  flex w-50 h-9 px-2 flex-col p-4 rounded-xl mt-2 font-semibold 
