...
const Uploadtest = () => {
  ...
  const handleUpload = async () => {
    if (!file) {
      setMessagetest("Veuillez sélectionner un fichier.");
      return;
    }
    ...
    try {
      ...
      setMessagetest(response.data.messagetest);
      
    } catch (error) {
      console.error("Erreur lors de l'envoi:", error);
      setMessagetest(error.response?.data.error || "Erreur inconnue");
    }
      ...
      <div className="py-6">
        <div className="grid border-2 border-cyan-400 p-7 rounded-lg">
          ...
          <div className="grid gap-5 mt-2">
            ...
            {messagetest && <p className="mt-4 text-l text-cyan-400 mx-auto">{messagetest}</p>}
