      ...
      <div className="border-2 flex justify-between border-cyan-400 p-3 rounded-2xl shadow-lg hover:shadow-cyan-400">
        ...
        <div className="flex gap-10 mr-5">
          <label>
            ...
            <div className="flex w-40 h-9 px-2 flex-col hover:text-cyan-300 hover:bg-gray-950 hover:border-2 p-5 bg-cyan-300 rounded-xl mt-2 text-black font-semibold leading-4 items-center justify-center cursor-pointer focus:outline-none">Choisir les fichiers</div>
          </label>
          <div
            onClick={handleUpload}
            className="flex w-28 h-9 px-2 flex-col hover:text-cyan-300 hover:bg-gray-950 hover:border-2 p-5 bg-cyan-300 rounded-xl mt-2 text-black font-semibold leading-4 items-center justify-center cursor-pointer focus:outline-none"
          >
            Télécharger
          </div>
        </div>
